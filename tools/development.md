...
### 依開源狀態
- [開源工具](#tag-opensource)
- [閉源工具](#tag-closedsource)

### 依地區
- [台灣](#tag-taiwan)
- [國際](#tag-international)
...
**簡介**  
領先的企業AI平台，專注於企業生成式AI、搜索發現和進階檢索功能。基於商業語言優化，
提供企業級解決方案。
...
**簡介**  
由聯發科技集團打造的生成式AI服務平台，強調資料安全性，提供開發者工具以開發客製化生成式AI擴充外掛和助理應用。
...
**簡介**  
專注於開源模型微調與部署的平台，提供playground環境供開發者測試和優化模型效果。
...
**簡介**  
聯發科技集團開發的生成式AI服務平台，強調資料安全性，提供開發者工具以開發客製化生成式AI擴充外掛和助理應用。
